...
urlpatterns = [
    ...
    path("admin/task-files/<int:file_id>/<str:action>/", views.admin_task_file_review, name="admin_task_file_review"),
    ...
    path("admin/reports/pdf/", views.report_pdf, name="report_pdf"),
